...
<table border="0" width="100%" height="100px" align="center">
 ...
 <form  method="post" enctype="multipart/form-data" style="border:2px solid #ccc;margin:2% 25%;">
  <div class="container">
    ...
    <div class="clearfix" >
      <button type="submit" class="signupbtn" style="background-color:green" name="signup">Sign Up</button>
	  <button type="reset" style="background-color:red" class="cancelbtn" name="signup">Clear</button>
