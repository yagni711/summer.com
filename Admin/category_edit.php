                ...
                <form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="ctype" class="form-control">
							...
							<?php 
								if($fetchv['c_type'] == 'Wedding Dresses'){
							?>
							
							<option value="Wedding Dresses" selected>Wedding Dresses</option>
							<option value="Wedding Trends">Wedding Trends</option>
							<option value="Cultural Extravagance">Cultural Extravagance</option>
							
							<?php 
								}
								else if($fetchv['c_type'] == 'Wedding Trends'){
							?>
							
							<option value="Wedding Dresses">Wedding Dresses</option>
							<option value="Wedding Trends" selected>Wedding Trends</option>
							<option value="Cultural Extravagance">Cultural Extravagance</option>
							...
							<option value="Wedding Dresses">Wedding Dresses</option>
							<option value="Wedding Trends">Wedding Trends</option>
							<option value="Cultural Extravagance" selected>Cultural Extravagance</option>
